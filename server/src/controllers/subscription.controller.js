...
exports.getCurrentSubscription = exports.handlePaymentFail = exports.handlePaymentSuccess = exports.initiateSubscription = void 0;
...
const handlePaymentSuccess = async (req, res) => {
    try {
        ...
        const calculatedHash = crypto_1.default.createHash('sha512').update(reverseHashString).digest('hex');
