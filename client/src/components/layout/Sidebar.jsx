            ...
            >
              {isCollapsed ? (
                <img
                  src="/logo.webp"
                  alt="VS"
                  className="h-10 w-10 object-contain rounded-lg flex-shrink-0 animate-coin-flip group-hover:scale-110 transition-transform duration-300"
                />
              ) : (
                <div className="flex items-center gap-3 px-2 w-full">
                  <img
                    src="/logo.webp"
                    alt="Veagle Space"
                    className="h-12 w-auto max-w-[140px] object-contain flex-shrink-0 animate-coin-flip group-hover:scale-105 transition-transform duration-300"
                  />
                </div>
              )}
            </Link>
