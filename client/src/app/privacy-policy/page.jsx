        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none bg-white dark:bg-slate-900 p-8 md:p-12 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-xl">
            ...
            <p>
              ...
              register for an account, create or modify your profile, generate
              invoices, request customer support, or communicate with us. The
              types of information we may collect include your name, email
              address, postal address, password, phone number, and any other
            ...
            <p>
              ...
              improve our invoice generation services. This includes using your
              information to:
            </p>
            <ul>
              <li>
              ...
              <li>
                ...
                events offered by Veagle Space Technology.
              </li>
            </ul>
            ...
            <p>
              ...
              behalf (e.g., payment processors like PayU).
            </p>

            <h2>4. Data Security</h2>
            <p>
              Veagle Space Technology takes reasonable measures to help protect
