      ...
      <main className="flex-1 pt-32 pb-20 px-6 md:px-12 max-w-7xl mx-auto w-full relative">
        ...
        <div className="text-center space-y-6 mb-20 max-w-3xl mx-auto">
          ...
          <p className="text-xl text-slate-600 dark:text-slate-400 leading-relaxed font-light">
            Have questions about Veagle Space or want to discuss enterprise features? We'd love to hear from you. Send us a message and we'll respond as soon as possible.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-5 gap-12 items-start">
            ...
            <div className="bg-white dark:bg-slate-900 rounded-[2rem] p-8 border border-slate-200 dark:border-slate-800 shadow-xl shadow-slate-200/50 dark:shadow-none hover:-translate-y-1 transition-all">
              <div className="flex items-start gap-4 mb-8">
                ...
                <div>
                  ...
                  <p className="text-slate-500 dark:text-slate-400 mb-2 font-light">Our friendly team is here to help.</p>
                  <a href="mailto:support@veaglespace.com" className="text-indigo-600 dark:text-indigo-400 font-semibold hover:underline">support@veaglespace.com</a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 mb-8">
                ...
                <div>
                  <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-1">Office</h3>
                  <p className="text-slate-500 dark:text-slate-400 mb-2 font-light">Come say hello at our headquarters.</p>
                  <p className="text-slate-700 dark:text-slate-300 font-medium">Pune, Maharashtra, India</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-500 dark:text-slate-400 mb-2 font-light">Mon-Fri from 9am to 6pm.</p>
                  <a href="tel:+918237999101" className="text-indigo-600 dark:text-indigo-400 font-semibold hover:underline">+91 82379 99101</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-3">
            <form onSubmit={handleSubmit} className="bg-white dark:bg-slate-900 rounded-[2rem] p-10 border border-slate-200 dark:border-slate-800 shadow-2xl shadow-slate-200/50 dark:shadow-none relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-indigo-50 dark:bg-indigo-900/20 rounded-bl-full -z-10"></div>
              
              <h2 className="text-3xl font-extrabold text-slate-900 dark:text-white mb-8 tracking-tight">Send us a message</h2>
