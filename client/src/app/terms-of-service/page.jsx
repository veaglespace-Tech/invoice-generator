      ...
      <main className="flex-1 pt-32 pb-24">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none bg-white dark:bg-slate-900 p-8 md:p-12 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-xl">
            ...
            <p>
              By accessing and using the invoice generation services provided by
              Veagle Space Technology, you agree to be bound by these Terms of
            ...
            <p>
              Some of our services are billed on a subscription basis. You will
              ...
              Payments are securely processed via PayU.
            </p>

            <h2>4. Acceptable Use</h2>
            <p>
              You agree not to use the service to generate invoices for illegal
              activities, fraudulent businesses, or to send spam. We reserve the
              right to terminate accounts that violate these guidelines without
              prior notice.
            </p>

            <h2>5. Limitation of Liability</h2>
            <p>
              In no event shall Veagle Space Technology, nor its directors,
            ...
            <p>
              ...
              <br />
              <strong>Veagle Space Technology Pvt. Ltd.</strong>
              <br />
