...
export default function InvoicePrintView() {
  ...
  const handleShare = async () => {
    if (!invoice || !invoice.customer.email) {
      alert(
        'This customer does not have an email address associated with them.'
      );
      return;
    }
    setIsSharing(true);
    try {
      const res = await fetchApi(`/invoices/${invoice.id}/send`, {
        method: 'POST'
      });
      if (res.success) {
            ...
            <div className="border border-black flex flex-col box-border">
                ...
                <div className="p-2 flex border-r border-black items-center">
                  ...
                  <div className="flex-1 flex flex-col items-center justify-center text-center">
                    ...
                    <div className="text-[11px] leading-tight max-w-[80%] mx-auto whitespace-pre-wrap">
                      {invoice.organization.address || 'Address not provided'}
                    </div>
                  </div>
                </div>
              ...
              <div className="flex border-b border-black text-[10px]">
                <div className="flex-1 p-1.5 border-r border-black flex">
                  ...
                  <span>{invoice.organization.GSTIN || 'Not Provided'}</span>
                </div>
                {(invoice.organization.settings?.field_visibility
                  ...
                  <div className="flex-1 p-1.5 border-r border-black flex">
                    ...
                    <span>{invoice.organization.PAN || 'Not Provided'}</span>
                  </div>
                )}
                {(invoice.organization.settings?.field_visibility
                  ?.supplierStateCode ??
                    ...
                    <div className="flex border-b border-black text-[10px]">
                      {invoice.organization.settings?.field_visibility
                        ...
                        >
                          ...
                          <span>{invoice.document_ref_no || ''}</span>
                        </div>
                      ) : null}
                      {invoice.organization.settings?.field_visibility
                        ?.documentDate ? (
                  ...
                  <div className="flex border-b border-black text-[10px]">
                    ...
                    {invoice.organization.settings?.field_visibility
                      ...
                      <div className="w-1/2 p-1.5 flex gap-2">
                        ...
                        <span>{invoice.category || 'B2B'}</span>
                      </div>
                    )}
                  </div>
                  {invoice.organization.settings?.field_visibility
                    ...
                    <div className="flex border-b border-black text-[10px]">
                      <div className="w-full p-1.5 flex gap-2">
                        ...
                        <span>{invoice.document_type_code || 'INV'}</span>
                      </div>
                    </div>
                  )}
              ...
              <div className="flex border-b border-black text-[10px]">
                  ...
                  {invoice.terms ? (
                    ...
                    <>
                      ...
                      <div className="mb-1">
                        ...
                        {invoice.organization.legal_name ||
                          invoice.organization.name}{' '}
                        on debit cards & UPI are reflective of non-levy of MDR
                        by acquiring banks and only represent the amount payable
                        by you to{' '}
                        {invoice.organization.legal_name ||
                          invoice.organization.name}{' '}
                ...
                <div className="w-[280px] flex flex-col">
                  ...
                  <div className="flex border-b border-black">
                    ...
                    <div className="w-1/2 p-1 text-right">
                      {Number(invoice.tax_total).toLocaleString('en-IN', {
                        minimumFractionDigits: 2
                      })}
                    </div>
                  </div>
              ...
              <div className="border-b border-black p-2 text-[10px]">
                ...
                {numberToWords(Number(invoice.grand_total))} Only
              </div>
