...
import { ArrowUpRight, ArrowDownRight, IndianRupee, Users, FileText, CheckCircle2, Loader2, Download } from 'lucide-react';
    ...
    <>
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
        ...
        <div className="flex gap-3">
          <button onClick={handleDownloadReport} className="btn btn-outline hover:scale-105 transition-all shadow-sm">
            ...
            <div className="h-[250px] w-full mt-4">
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={[
                  ...
                  { name: 'Jun', revenue: cards.totalPaidAmount || 7000 },
                ]}>
                  <defs>
