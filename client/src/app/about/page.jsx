      ...
      <main className="flex-1 pt-32 pb-20 px-6 md:px-12 max-w-6xl mx-auto w-full relative">
        ...
        <div className="text-center space-y-6 mb-20">
          ...
          <p className="text-xl text-slate-600 dark:text-slate-400 max-w-3xl mx-auto leading-relaxed font-light">
            Veagle Space Technology Pvt. Ltd. is dedicated to building elite
            enterprise tools for modern teams. We focus on uncompromising
            security, absolute transparency, and technological excellence.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <div className="bg-white dark:bg-slate-900 rounded-[2rem] p-10 border border-slate-200 dark:border-slate-800 shadow-xl shadow-slate-200/50 dark:shadow-none hover:shadow-2xl hover:border-indigo-300 dark:hover:border-indigo-500/50 transition-all duration-300 group relative overflow-hidden transform hover:-translate-y-1">
            ...
            <p className="text-slate-600 dark:text-slate-400 mb-10 leading-relaxed text-lg font-light">
              We take your data privacy seriously. Read our comprehensive policy
              to understand how we collect, use, and protect your personal and
              business information with enterprise-grade security.
            </p>
            <Link
              href="/privacy-policy"
              className="inline-flex items-center font-bold text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300 group-hover:underline decoration-2 underline-offset-4 transition-all"
            >
              Read Privacy Policy{' '}
          ...
          <div className="bg-slate-900 dark:bg-black rounded-[2rem] p-10 border border-slate-800 shadow-2xl shadow-slate-900/20 hover:shadow-3xl hover:border-emerald-500/50 transition-all duration-300 group relative overflow-hidden transform hover:-translate-y-1">
            ...
            <p className="text-slate-300 mb-10 leading-relaxed text-lg font-light">
              Understand the rules, guidelines, and agreements that govern your
              use of the Veagle Space invoicing platform. We believe in clear,
              transparent, and fair terms for all our users.
            </p>
            <Link
              href="/terms-of-service"
              className="inline-flex items-center font-bold text-emerald-400 hover:text-emerald-300 group-hover:underline decoration-2 underline-offset-4 transition-all"
            >
