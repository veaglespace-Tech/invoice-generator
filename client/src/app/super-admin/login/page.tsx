      ...
      <main className="flex-1 flex flex-col items-center justify-center p-6 md:p-12 z-10 pt-24">
        <div className="w-full max-w-md bg-white dark:bg-slate-900 rounded-3xl shadow-xl border border-slate-100 dark:border-slate-800 p-8 md:p-10 animate-in fade-in slide-in-from-bottom-4 duration-500 mt-12 relative overflow-hidden">
          ...
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-slate-900 dark:text-white">Super Admin Portal</h2>
            <p className="text-slate-500 dark:text-slate-400 mt-2">Restricted access. Authorized personnel only.</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                <label className="text-sm font-medium text-slate-700 dark:text-slate-300">Master Password</label>
              </div>
              <input
                type="password"
                value={password}
